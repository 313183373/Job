const country = {
    ...
    "Bermuda": '百慕大',
    "Bhutan": '不丹',
    "Bolivia, Plurinational State of": '玻利维亚（多民族国）',
    ...
    "Holy See (Vatican City State)": '教廷(梵蒂冈城)',
    "Honduras": '洪都拉斯',
    "Hong Kong": '中国香港',
    "Hungary": '匈牙利',
    "Iceland": '冰岛',
    ...
    "Kenya": '肯尼亚',
    "Kiribati": '基里巴斯',
    "Korea, Democratic People's Republic of": '韩国',
    "Korea, Republic of": '朝鲜',
    "Kuwait": '科威特',
    "Kyrgyzstan": '吉尔吉斯斯坦',
    ...
    "United Kingdom": '英国',
    "United States": '美国',
    "United States Minor Outlying Islands": '美国小型离岛',
    "Uruguay": '乌拉圭',
    "Uzbekistan": '乌兹别克斯坦',
    "Vanuatu": '瓦努阿图',
